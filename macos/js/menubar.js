...
const MenuBar = {
  ...
  appleMenuItems() {
    return [
      ...
      { sep: true },
      { label: "Log Out HoleTex…", shortcut: "⇧⌘Q", action: () => showLockScreen() },
    ];
  },
  ...
  defaultFinderMenus() {
    return [
      ...
      { title: "Help", items: [
        { label: "macOS Web Help", action: () => MacOS.notify("Help", "Made by HoleTex — everything runs in your browser.", Icons.finder) },
      ]},
    ];
  },
  ...
  buildRight() {
    ...
    mkStatus(Glyphs.wifi, "Wi‑Fi: HoleTex Studio");
...
function openAboutWindow() {
  ...
  win.content.innerHTML = `
    <div class="about">
      ...
      <table>
        <tr><td>Chip</td><td>HoleTex W1 Max</td></tr>
...
function showLockScreen() {
  ...
  lock.innerHTML = `
    ...
    <div class="lock-name">HoleTex</div>
