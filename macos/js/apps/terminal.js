...
MacOS.registerApp({
  ...
  mount(root, win) {
    ...
    const FS = {
      ...
      Pictures: {},
      "README.md": "macOS Web by AI Fable5.\nType `help` to see available commands.",
    };
    ...
    const promptHtml = () =>
      `<span class="term-prompt-user">fable5@macbook-pro</span> <span class="term-prompt-path">${escapeHtml(pathStr())}</span> <span class="term-dim">%</span> `;
    ...
    const COMMANDS = {
      ...
      pwd() { printText("/Users/fable5" + (cwd.length ? "/" + cwd.join("/") : "")); },
      cat(args) {
      ...
      neofetch() {
        ...
        const info = [
          `<span class="nf-k">fable5</span>@<span class="nf-k">macbook-pro</span>`,
          ...
          `<span class="nf-k">WM:</span> fable5 WM`,
